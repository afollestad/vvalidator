...
internal class EditTextNotEmptyAssertion : Assertion<EditText>() {
...
/** @author Aidan Follestad (@afollestad) */
internal class EditTextUrlAssertion : Assertion<EditText>() {
...
/** @author Aidan Follestad (@afollestad) */
internal class EditTextUriAssertion(
...
/** @author Aidan Follestad (@afollestad) */
internal class EditTextEmailAssertion : Assertion<EditText>() {
...
/** @author Aidan Follestad (@afollestad) */
internal class EditTextNumberAssertion : Assertion<EditText>() {
  override fun isValid(view: EditText): Boolean {
...
/** @author Aidan Follestad (@afollestad) */
internal class EditTextLengthExactlyAssertion(
...
/** @author Aidan Follestad (@afollestad) */
internal class EditTextLengthLessThanAssertion(
...
/** @author Aidan Follestad (@afollestad) */
internal class EditTextLengthAtMostAssertion(
  private val ceil: Int
) : Assertion<EditText>() {
  override fun isValid(view: EditText): Boolean {
    return view.text.length <= ceil
...
/** @author Aidan Follestad (@afollestad) */
internal class EditTextLengthAtLeastAssertion(
...
/** @author Aidan Follestad (@afollestad) */
internal class EditTextLengthGreaterThanAssertion(
  private val floor: Int
) : Assertion<EditText>() {
  override fun isValid(view: EditText): Boolean {
    return view.text.length > floor
...
/** @author Aidan Follestad (@afollestad) */
internal class EditTextContainsAssertion(
...
/** @author Aidan Follestad (@afollestad) */
internal class EditTextRegexAssertion(
  regexString: String,
